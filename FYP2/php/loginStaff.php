...
if (isset($_POST["submit"])){
    ...
    $email = $_POST["email"];
    $pass =  $_POST["pass"];
    $stmt = $conn->prepare("SELECT * FROM tbl_loginstaff WHERE email = '$email' AND pass = '$pass'");
    $stmt->execute();
    ...
    if ($number_of_rows > 0) {
        ...
        echo "<script> window.location.replace('viewVisitor.php')</script>";
    } else {
...
<body>
        <div class="v78_147">
            ...
            <span class="v78_150">Login for Staff</span>

            <form name="loginForm" class="w3-container" action="loginStaff.php" method="post">
...
Copyright 2021 - Universiti Utara Malaysia</span></div>
