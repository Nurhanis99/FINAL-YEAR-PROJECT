...
<html lang="en">
<head>
    <title>Apply Visitor Pass</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="w3-top">
        ...
        <a href="../php/addNewRegistration.php" class="w3-bar-item w3-button">+ Add New Registration</a>
            ...
            <a href="../php/applyVisitor.php" class="w3-bar-item w3-button w3-bold" style="color: #faff00;"><i class="fa fa-angle-down"></i> &nbsp Apply Visitor Pass</a>
    ...
    <div class="w3-container w3-white" style="padding:80px 100px" id="form">
        <div style="margin-top:40px">
            <form action="../server/addapplypass.php" method="POST" enctype="multipart/form-data">
                <?php
                ...
                ?>
                <h3 class="w3-left" style="font-weight: bold;">Apply Visitor Pass</h3><br><br><br>
                ...
                <div class="form-group">
                    <label>Reason</label>
                    <textarea type="text" class="form-control" value="" placeholder="Why you need to enter inasis" name="reason" required></textarea>
                </div>
                <div class="form-group">
                    <label>Date</label>
                ...
                <div class="form-group">
                    <label>Time</label>
                    <input type="time" class="form-control" value="" placeholder="Enter time" name="time" required>
                </div>
                <div class="form-group">
                    <label>Upload Visitor Picture</label>
                    <input type="file" class="form-control" value="Upload" placeholder="Choose photo" name="upload_pic" accept=".jpg, .png, .jpeg" required>
                </div>
                <div>
                    <p>
                        <button class="w3-button w3-green w3-right" type="submit" name="submitupload" style="border-radius: 5px">APPLY</button>
                    </p>
                </div>
            </form>
        </div>
