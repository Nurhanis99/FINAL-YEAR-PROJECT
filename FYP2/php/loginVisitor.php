...
if (isset($_POST["submit"])){
    ...
    $email = $_POST["email"];
    $pass =  $_POST["pass"];
    $stmt = $conn->prepare("SELECT * FROM tbl_loginvisitor WHERE email = '$email' AND pass = '$pass'");
    $stmt->execute();
    ...
    if ($number_of_rows > 0) {
        ...
        echo "<script> window.location.replace('addNewRegistration.php')</script>";
    } else {
...
<body>
        <div class="v78_147">
            ...
            <span class="v78_150">Login for Visitor</span>

            <form name="loginForm" class="w3-container" action="loginVisitor.php" method="post">
