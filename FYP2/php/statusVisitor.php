...
<html lang="en">
<head>
    <title>Status Visitor Pass</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="w3-top">
        ...
        <a href="../php/addNewRegistration.php" class="w3-bar-item w3-button">+ Add New Registration</a>
            ...
            <a href="" class="w3-bar-item w3-button w3-bold" style="color: #faff00;"><i class="fa fa-angle-down"></i> &nbsp Status Visitor Pass</a>
    ...
    <div class="w3-container w3-white" style="padding:350px 0px">
        <div class="w3-display-middle w3-card" style="width:70%">
            ...
            <div id="Activities" class="w3-container w3-white w3-padding-16 myLink">
                <h3 class="w3-left w3-bold">Status of Apply Visitor Pass </h3><br>
                            ...
                            while($result = mysqli_fetch_array($querydisplay)){
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center">
                                        <a class='btn btn-success btn-sm print-button' href="download.php?view=<?php echo $result['id']; ?>">Download</a>
                                    </td>
                                </tr>                            
                                <?php
                            }
