...
<html lang="en">
<head>
    <title>View Details of Visitor Pass</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="w3-top">
        <div class="w3-bar w3-indigo w3-card" id="myNavbar">
            <a href="" class="w3-bar-item w3-button w3-bold"><i class="fa fa-angle-down"></i> &nbsp View Detail Visitor Pass</a>
            ...
            <div class="w3-col m6">
                <div class="w3-card" style="padding: 20px">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <a class='btn btn-primary btn-sm' href="../php/viewVisitor.php" style="font-size:15px">< &nbsp Back</a> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
