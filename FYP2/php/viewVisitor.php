...
<body>
    ...
    <div class="w3-top">
        ...
        <a href="../php/viewVisitor.php" class="w3-bar-item w3-button" style="color: #faff00;"> &nbsp<i class="fa fa-angle-down"></i> &nbsp View Visitor Apply</a> 
            ...
            <div class="w3-right w3-hide-small">
                <a href="../php/loginStaff.php" class="w3-bar-item w3-button">Logout</a>
            </div>
    ...
    <div class="w3-container w3-white" style="padding:350px 0px">
        <div class="w3-display-middle w3-card" style="width:70%">
            ...
            <div id="Activities" class="w3-container w3-white w3-padding-16 myLink">
                <h3 class="w3-left w3-bold">Applying Visitor Pass </h3><br>
                ...
                <thead>
                    <!-- <th>Poster</th> -->
                    <!-- <th style="text-align:center">Visitor Picture</th> -->
                    ...
                    <tbody>
                        <?php
                            ...
                            $displayquery = "SELECT * FROM tbl_applypass";
                            ...
                            while($result = mysqli_fetch_array($querydisplay)){
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center"> <?php echo $result['visitorname']; ?> </td>
                                    <td style="text-align:center"> <?php echo $result['date']; ?> </td>
                                    <td style="text-align:center"> <?php echo $result['inasis']; ?> </td>
                                    <td style="text-align:center"> <?php echo $result['reason']; ?> </td>
                                    <!-- <td style="color: green; text-align:center;"><b>Approved</b></td> -->
                                    <td style="text-align:center">
                                        <a class='btn btn-success btn-sm viewbtn' href="../php/viewDetail.php? view=<?php echo $result['id']; ?>">View Details</a>
                                        <a class='btn btn-danger btn-sm deletebtn' href="../server/deleteApply.php?delete=<?php echo $result['id']; ?>">Delete</a>
                                    </td>
                                </tr>                            
                                <?php
                            }
