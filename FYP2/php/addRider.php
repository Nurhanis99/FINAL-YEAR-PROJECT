...
<html lang="en">
<head>
    <title>Add Rider Information</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="w3-top">
        ...
        <a href="../php/addRider.php" class="w3-bar-item w3-button" style="color: #faff00;"><i class="fa fa-angle-down"></i> &nbsp + Add Rider Information</a>
            <!-- <a href="../php/updateVisitor.php" class="w3-bar-item w3-button w3-bold"> Update Rider Information</a> -->
            <!-- <a href="clubpage.php" class="w3-bar-item w3-button">Club Programme</a> -->
            
            <!-- Right-sided navbar links -->
            <div class="w3-right w3-hide-small">
                <a href="../php/loginRider.php" class="w3-bar-item w3-button">Logout</a>
            </div>
    ...
    <div class="w3-container w3-white" style="padding:80px 100px" id="form">
        <div style="margin-top:40px">
            <form action="../server/addRider.php" method="POST" enctype="multipart/form-data">
                <?php
                ...
                ?>
                <h3 class="w3-left" style="font-weight: bold;">Add New Rider Information</h3><br><br><br>
                <p>Please fill in all the details of the rider</p>
                <div class="form-group">
                    <label>Name</label>
                    <input type="text" class="form-control" value="" placeholder="Enter name" name="ridername" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label>Message</label>
                    <textarea type="text" class="form-control" value="" placeholder="Enter message for student" name="message" required></textarea>
                </div>
                <div class="form-group">
                    <label>Upload Rider Picture</label>
